  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Dar entrada dos Medicamentos</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
...
$sql="SELECT * FROM produto WHERE idp=$idproduto";
...
<body>
   <div class="container">
    ...
    <form action="Dar_entrada_script.php" method="Post" class="row g-3">
    <input type="hidden" name="id_admin" value="<?php echo $id_admin; ?>">
    <input type="hidden" name="idproduto" value="<?php echo $idproduto; ?>">
  <div class="col-md-6">
    <label for="nome" class="form-label">Nome do Medicamanto/Descrição/Categoria</label>
    <input type="text" class="form-control" name="nome" id="inputEmail4" 
     placeholder="PARACETAMOL"  value="<?php echo $linha['nome']?> 
     <?php echo $linha['descricao']?> <?php echo $linha['categoria']?>">
  </div>
  <div class="col-md-6">
    <label for="quantidade" class="form-label">Quantidade do Medicamento</label>
    <input type="number" class="form-control" id="inputPassword4" name="quantidade" 
     placeholder="DIGITE AQUI QUANTIDADE">
  </div>
  <div class="col-md-6">
    <label for="preco" class="form-label">Preço do Medicamanto</label>
    <input type="number" class="form-control" id="inputAddress" name="preco"
     placeholder="DIGITE AQUI O PREÇO">
  </div>
  <div class="col-md-6">
    <label for="data" class="form-label">Data de entrada do Medicamanto</label>
  ...
  <div class="col-md-6">
    ...
    <input type="date" class="form-control" id="inputAddress" name="caducidade">
  </div>
