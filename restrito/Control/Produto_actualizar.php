...
$sql="SELECT * FROM `produto` WHERE `idp`='$id_produto'";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
     ...
     <form action="Produto_actualizar_script.php" method="Post" class="row g-3">
     <input type="hidden" name="id_admin" value="<?php echo $id_admin; ?>">
  <div class="col-md-6">
    <label for="nome" class="form-label">Nome do Medicamanto</label>
    <input type="text" class="form-control" name="nome" id="inputEmail4"  placeholder="PARACETAMOL"
    value="<?php echo $linha['nome'] ?>"  required>
  </div>
  <div class="col-md-6">
    <label for="descricao" class="form-label">Descrição do Medicamento</label>
    <input type="text" class="form-control" id="inputPassword4" name="descricao"  placeholder="250MG"
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="inputAddress" name="categoria"
     placeholder="COMPRMIDO" value="<?php echo $linha['categoria'] ?>"  required>
  </div>

  <div class="col-md-12">
  </br>
    <button type="submit" class="btn btn-primary">Actualizar o Medicamanto</button>
    <input type="hidden" name="id_produto" id="id_produto" value="<?php echo $linha['idp'] ?>" >
    <input type="hidden" name="idfuncionario" id="idfuncionario" value="<?php echo $linha['idf'] ?>" >
  </div>
</form>  
            </div>
        </div>
