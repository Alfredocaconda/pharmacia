  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Relatório Personalizado</h1>
            <form action="Control/imprimirTodas.php" method="post">
              <label for="">Data Requerida</label>
              <input type="date" name="datae">
              <label for="">Data Actual</label>
              <input type="date" name="datapara">
